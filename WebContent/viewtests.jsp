  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      ...
      <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="#">view Equipment</a></li>
            <li><a class="dropdown-item" href="#">view Technician</a></li>
...
<tr>
   ...
   <th bgcolor="cyan">  Types of tests available</th>
...
Connection con = null;
	...
	ResultSet rs = con.createStatement().executeQuery("select * from tests");
